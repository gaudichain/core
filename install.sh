...
echo 'alias gaudichain="$HOME/core-bridgechain/packages/core/bin/run"' >> ~/.bashrc

rm -rf "$HOME/core-bridgechain"
git clone "https://github.com/gaudichain/core" "$HOME/core-bridgechain" || FAILED="Y"
if [ "$FAILED" == "Y" ]; then
    echo "Failed to fetch core repo with origin 'https://github.com/gaudichain/core'"
...
rm -rf "$HOME/.config/@gaudichain"
rm -rf "$HOME/.config/@gaudichain"
rm -rf "$HOME/.config/gaudichain-core"
